...
const ArticlePage : React.FC = () => {
  ...
  const article = articles && articles[0];
    ...
    return (
        <div className="relative isolate overflow-hidden bg-zinc-100 px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
          ...
          <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
            <div className="lg:pr-4">
              <div className="lg:max-w-lg">
                <p className="text-base font-semibold leading-7 text-indigo-600">{article?.articleType}</p>
